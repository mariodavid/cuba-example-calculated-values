...
public class CecvTestContainer extends TestContainer {

    public CecvTestContainer() {
        super();
    ...
    public static class Common extends CecvTestContainer {

        public static final CecvTestContainer.Common INSTANCE = new CecvTestContainer.Common();
